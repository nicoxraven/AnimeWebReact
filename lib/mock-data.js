...
{
  id: 's1',
  slug: 'starfall-mecha-series',
  title: 'Starfall Mecha: The Series',
  type: 'series',
  cover: COVERS.mecha,
  year: 2025,
  rating: 8.8,
  ...
  studio: 'Gigawatt',
  synopsis:
  'The full series adaptation — follow the pilot and her crew across 12 episodes as they defend the last city from the titan threat.',
  premium: false,
  episodes: 12,
  trending: true
},
{
  id: 's2',
  slug: 'neon-blade-syndicate',
  title: 'Neon Blade: Syndicate',
  type: 'series',
  cover: COVERS.blade,
  year: 2025,
  rating: 9.1,
  ...
  studio: 'Kaze Pictures',
  synopsis:
  'The swordsman returns in a 10-episode series, hunting the syndicate across the neon underworld one blade at a time.',
  premium: true,
  episodes: 10,
  trending: true
},
{
  id: 's3',
  slug: 'celestial-gate-chronicles',
  title: 'Celestial Gate Chronicles',
  type: 'series',
  cover: COVERS.celestial,
  year: 2024,
  rating: 8.9,
  ...
  studio: 'Studio Aurora',
  synopsis:
  'A 24-episode journey through every gate ever opened — the shrine maidens who shaped the fate of two worlds.',
  premium: true,
  episodes: 24,
  trending: false
}];
